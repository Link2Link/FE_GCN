...
class OptInit:
    def __init__(self):
        parser = argparse.ArgumentParser(description='PyTorch implementation of Deep GCN For semantic segmentation with full velodyne data')
    ...
    def _generate_exp_directory(self):
        ...
        self.args.pred_dir = os.path.join(self.args.exp_dir, "pred")
        ...
        pathlib.Path(self.args.pred_dir).mkdir(parents=True, exist_ok=True)
