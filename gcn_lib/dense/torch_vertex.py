...
class ResBlock2d(nn.Module):
    ...
    def __init__(self, in_channels, conv='edge', act='relu', norm=None, bias=True, res_scale=1):
...
class DenseBlock2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=64, conv='edge', act='relu', norm=None, bias=True):
