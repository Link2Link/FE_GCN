...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/pointpillar_SYM_GCN.yaml', help='specify the config for training')
...
if __name__ == '__main__':
    ...
    cfg.ROOT_DIR = (Path(os.environ['HOME']) / 'work_dir').resolve()
